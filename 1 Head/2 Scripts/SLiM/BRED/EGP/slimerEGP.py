...
mrts = ["1e-06","1e-07","1e-08"]    #  ["1e-09","1e-08","1e-07"]            1e-7 или 0.0000001 => от 1/kkk (1e-06 peregruzka po pamyati)
eps = ["1e-04","1e-05","1e-06"]
        ...
        for e in eps:
            for m in mrts:
                for j in range(1):
                    ...
                    reps.write("    initializeMutationRate(1e-05);\n")	

                    #// m1 mutation type: neutral
                    reps.write("	initializeMutationType(\"m1\", 1, \"f\", -0.00001);\n") # normal ?  itializeMutationType("m2", 0.5, "n", 0.0, 1.0);   // QTL
                    ...
                    reps.write("	initializeRecombinationRate(1e-5);\n")
                    reps.write("    initializeSex(\"A\");\n") 
                    reps.write("}")

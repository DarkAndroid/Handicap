...
for p in pszs:
    for g in gszs:
        for e in eps:
            ...
            reps.write("	initializeMutationType(\"m2\", 0.5, \"f\", 0.5);\n")
            #// g1 genomic element type: uses m1 for all mutations
            reps.write("	initializeGenomicElementType(\"g1\", c(m1,m2), c(1,99));\n")
            ...
            for i in range(1,101):
                ...
                #reps.write("    writeFile(\"sim%s.output\", \"%s \" + i.pedigreeID +\"   \" + i.pedigreeParentIDs, append=T);\n" % (n,i*100))
                reps.write("    writeFile(\"sims/sim.out\", , append=T);\n")
                reps.write("}\n")
                reps.write("}\n")
